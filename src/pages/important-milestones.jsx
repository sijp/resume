  ...
  return (
    <Container
      ...
      style={{
        ...
        paddingTop: 100,
        backgroundColor: "#DDD",
        backgroundImage: "url(./wallpaper-milestones.jpg)"
      }}
    >
      <Milestones
        steps={steps}
      ...
      >
        <>
          ...
          <Typography gutterBottom>
            User Interface was developed using Sencha ExtJS 4.2, deployment
            using Capistrano to AWS EC2.
          </Typography>
          <Typography>
        ...
        <>
          ...
          <Typography gutterBottom>
            Made an intensive research on Micro Services architecture, and
            decided to base on Sam Newman's book "Building Microservices".
            Developed the first services in Python that were responsible to
            manage long asynchronous tasks.
          </Typography>
          <Typography gutterBottom>
        ...
        <>
          ...
          <Typography gutterBottom>
            ...
            developers, making the team twice as large. I was responsible for
            the team's technical growth as a technical mentor.
          </Typography>
          <Typography gutterBottom>
            Also, I was given the task of being the architect of the new
            customer facing analysis application using Node.js and React over
            Elastic Search and Couchbase. I lead the team and provided technical
        ...
        <>
          ...
          <Typography gutterBottom>
            ...
            building micro services. Using Domain Driven Development concepts
            and prioritizing the concepts of loose coupling and high cohesion.
          </Typography>
          <Typography gutterBottom>
            The framework allowed the core team to develop the next generation
            analysis application's requirements as an eco system built of
            numerous micro services which is tolerant for changes and new
            requirements.
          </Typography>
          <Typography gutterBottom>
        ...
        <>
          ...
          <Typography gutterBottom>
            During my role as a team lead, I provided technological consultancy
            to two other teams in my group.
          </Typography>
          <Typography gutterBottom>
            ...
            main tools was providing tools for customers' developers to
            integrate with our APIs. We used our framework to build an
            application which was fully integrated with our Single Sign-on
